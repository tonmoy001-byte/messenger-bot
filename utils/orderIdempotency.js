 ...
 * Includes uid, items, tenant_id, and optional customer identifiers.
 * tenant_id prevents cross-tenant collision on the same fingerprint.
 */
...
/**
 * Look for a recent duplicate order for the same uid + amount.
 * Optional opts.tenant_id scopes the lookup to one tenant.
 * opts.windowMs defaults to 120000.
 */
